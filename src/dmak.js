 ;(function () {
	...
	function drawStroke(paper, stroke, timeouts, options) {
		var cb = function() {
			...
			stroke.object.path.node.style.transition = stroke.object.path.node.style.WebkitTransition = "stroke 300ms ease";
			
			//luan add
			stroke.object.path.node.style.stroke = "black";
			// stroke.object.path.node.style.strokeWidth = "15px";
